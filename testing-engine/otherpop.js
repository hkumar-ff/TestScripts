  ...
  try {
...

    {
      ...
      await puppeteer.Locator.race([
        ...
        .setTimeout(5000)
        .fill(email); // Use the email from otherpop.js
      await sleepFunc();
      await takeScreenshotFunc();
      await sleepFunc();
    }
    ...
    if (!pageText.includes('Assistance required:- Testing I need help with SOC2.')) {
      console.log('FAIL: Assistance message "Assistance required:- Testing I need help with SOC2." not found in Salesforce lead details.');
      await browser.close();
      process.exit(1);
    }

    // Check if summary of choices is found on the page
    if (!pageText.includes('Summary of Choices:- Industry: Retails and Payment Providers, For company, Certification: Other')) {
      console.log('FAIL: Summary of choices "Summary of Choices:- Industry: Retails and Payment Providers, For company, Certification: Other" not found in Salesforce lead details.');
      await browser.close();
      process.exit(1);
    }
    ...
    console.log('PASS: Assistance Message - Form: "Testing I need help with SOC2.", Found in Salesforce: YES');
    console.log('PASS: Summary of Choices - Form: "Summary of Choices:- Industry: Retails and Payment Providers, For company, Certification: Other", Found in Salesforce: YES');
